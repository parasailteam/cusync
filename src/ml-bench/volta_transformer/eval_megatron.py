...
if model == "gpt3" and attention_or_mlp == "attention":
  tiles = {
    ...
    1024: {"TileSizes" : [256, 128, 32, 128, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [2,3,1,1], "SoftmaxRowTile" : 4},
      "tilesync": {"split_ks": [2,3,1,1], "SoftmaxRowTile" : 1,
      "AvoidCustomOrder": False,
      "AvoidWaitKernel": False,
      "ReorderTileLoads": True},
      "rowsync": {"split_ks": [2,3,1,1], "SoftmaxRowTile" : 1}
    },
    512: {"TileSizes" : [256, 128, 32, 128, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [2,2,1,1], "SoftmaxRowTile" : 1},
      "tilesync": {"split_ks": [2,2,1,1], "SoftmaxRowTile" : 1,
      "AvoidCustomOrder": False,
      "AvoidWaitKernel": False,
      "ReorderTileLoads": True},
      "rowsync": {"split_ks": [2,2,1,1], "SoftmaxRowTile" : 1}
    },
    256: {"TileSizes" : [256, 128, 32, 128, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Tile-Sync",
      "baseline": {"split_ks": [6,4], "SoftmaxRowTile" : 1},
      "tilesync": {"split_ks": [4,2], "SoftmaxRowTile" : 4,
      "AvoidCustomOrder": True,
      "AvoidWaitKernel": True,
      "ReorderTileLoads": True},
      "rowsync": {"split_ks": [4,2], "SoftmaxRowTile" : 4,
      "AvoidCustomOrder": True,
      "AvoidWaitKernel": True}
    },
    ...
    64: {"TileSizes" : [64, 256, 32, 64, 64, 32], "MaxTBsPerSM": 3, "Best-Policy": "Tile-Sync",
    ...
    32: {"TileSizes" : [32, 128, 32, 32, 32, 32], "MaxTBsPerSM": 3,
    ...
    16: {"TileSizes" : [32, 128, 32, 32, 32, 32], "MaxTBsPerSM": 3,
      "baseline": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1},
      "tilesync": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1,
      "AvoidCustomOrder": True,
      "AvoidWaitKernel": True,
    ...
    8: {"TileSizes" : [32, 128, 32, 32, 32, 32], "MaxTBsPerSM": 3,
      "baseline": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1},
      "tilesync": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1,
      "AvoidCustomOrder": True,
      "AvoidWaitKernel": True,
    ...
    4: {"TileSizes" : [32, 128, 32, 32, 32, 32], "MaxTBsPerSM": 3,
      "baseline": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1},
      "tilesync": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1,
      "AvoidCustomOrder": True,
      "AvoidWaitKernel": True,
    ...
    2: {"TileSizes" : [32, 128, 32, 32, 32, 32], "MaxTBsPerSM": 3,
      "baseline": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1},
      "tilesync": {"split_ks": [4,3,1,2], "SoftmaxRowTile" : 1,
      "AvoidCustomOrder": True,
      "AvoidWaitKernel": True,
  ...
  tiles = {
    ...
    16: {"TileSizes" : [32, 256, 32, 32, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [6,2]},
      "rowsync": {"split_ks": [6,2], 
                   "AvoidWaitKernel": True,
                   "AvoidCustomOrder": True},
    ...
    8: {"TileSizes" : [32, 256, 32, 32, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [6,2]},
      "rowsync": {"split_ks": [6,2], 
                   "AvoidWaitKernel": True,
                   "AvoidCustomOrder": True},
    ...
    4: {"TileSizes" : [32, 256, 32, 32, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [6,2]},
      "rowsync": {"split_ks": [6,2], 
                   "AvoidWaitKernel": True,
                   "AvoidCustomOrder": True},
    ...
    2: {"TileSizes" : [32, 256, 32, 32, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [6,2]},
      "rowsync": {"split_ks": [6,2], 
                   "AvoidWaitKernel": True,
                   "AvoidCustomOrder": True},
    ...
    1: {"TileSizes" : [32, 256, 32, 32, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      "baseline": {"split_ks": [6,2]},
      "rowsync": {"split_ks": [6,2], 
                   "AvoidWaitKernel": True,
                   "AvoidCustomOrder": True},
  ...
  tiles = {
    ...
    0: {
      ...
      512: {"TileSizes" : [128, 128, 32, 64, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Row-Sync",
      ...
      256: {"TileSizes" : [128, 128, 32, 64, 64, 32], "MaxTBsPerSM": 2, "Best-Policy": "Tile-Sync",
...
for case in [ (0,512), (0, 1024), (0, 2048)]:#[1,2,4,8,16,32,64,512,1024,2048]:
  ...
  baselineCommand = buildDir(f"{attention_or_mlp}-eval-baseline") + commandArgs
  ...
  if "Invalid" in o:
    ...
    print(f'{m} & {str(seq) + "&" if attention_or_mlp == "attention" else ""} {H} & baseline & {"%.2f"%avg(bTimeTotal)} & {"%.2f"%stdev(bTimeTotal)} & {"%.2f"%avg(bTimeMatmul1)} & {"%.2f"%avg(bTimeMatmul2)}')
    baselineDone = True

  for syncPolicy in policies:
    if syncPolicy == 'stridedsync':
      b = f"{attention_or_mlp}-{model}-eval-{syncPolicy}"
    else:
      b = f"{attention_or_mlp}-eval-{syncPolicy}"
    command = buildDir(b) + commandArgs
    ...
    print(f'{m} & {str(seq) + "&" if attention_or_mlp == "attention" else ""} {H} & {syncPolicy} & {"%.2f"%avg(bTimeTotal)} & {"%.2f"%stdev(bTimeTotal)} & {"%.2f"%avg(bTimeMatmul1)} & {"%.2f"%avg(bTimeMatmul2)} & {"%.2f"%avg(otime)} & {"%.2f"%stdev(otime)} & {"%.2f"%(100 - avg(otime)/avg(bTimeTotal)*100)}')
